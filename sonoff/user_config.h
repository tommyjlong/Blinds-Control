...
//#define MODULE                 SONOFF_BASIC      // [Module] Select default model from sonoff_template.h (Should not be changed) Tommy Changed
#define MODULE                 WEMOS             // Tommy Same as Generic
...
// -- I2C sensors ---------------------------------
//#define USE_I2C                                  // I2C using library wire (+10k code, 0k2 mem, 124 iram); TOMMY Disabled
...
//#define USE_IR_REMOTE                            // Send IR remote commands using library IRremoteESP8266 and ArduinoJson (+4k code, 0k3 mem, 48 iram) TOMMY Disable
//  #define USE_IR_HVAC                            // Support for HVAC system using IR (+2k code)
//  #define USE_IR_RECEIVE                         // Support for IR receiver (+5k5 code, 264 iram) TOMMY Disable

//#define USE_WS2812                               // WS2812 Led string using library NeoPixelBus (+5k code, +1k mem, 232 iram) - Disable by // TOMMY Disable
//  #define USE_WS2812_CTYPE     NEO_GRB           // WS2812 Color type (NEO_RGB, NEO_GRB, NEO_BRG, NEO_RBG, NEO_RGBW, NEO_GRBW) TOMMY Disable
//  #define USE_WS2812_DMA                         // DMA supports only GPIO03 (= Serial RXD) (+1k mem). When USE_WS2812_DMA is enabled expect Exceptions on Pow

//#define USE_ARILUX_RF                            // Add support for Arilux RF remote controller (+0k8 code, 252 iram (non 2.3.0)) TOMMY Disable

//#define USE_SR04                                 // Add support for HC-SR04 ultrasonic devices (+1k code) TOMMY Disable

//#define USE_TM1638                               // Add support for TM1638 switches copying Switch1 .. Switch8 (+1k code)

//#define USE_RF_FLASH                             // Add support for flashing the EFM8BB1 chip on the Sonoff RF Bridge. TOMMY Disable
                                                   // C2CK must be connected to GPIO4, C2D to GPIO5 on the PCB (+3k code)

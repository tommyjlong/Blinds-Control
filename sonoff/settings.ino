...
//  Settings.flag.mqtt_response = 0; //This is originally commented out.
  Settings.flag.mqtt_response = 1; //TOMMY change setoption4 default. Note: Sonoff changes this in HA Discovery if enabled. 
...
//  Settings.flag.knx_enable_enhancement = 0;
  ...
  // Light
  Settings.flag.pwm_control = 0;  //TOMMY Change the default to be controlled by PWM not DIMMER.
  ...
  Settings.flag3.slow_servo = 1;  //TOMMY Servo Blinds Control flag. Regular PWM = 0, Blinds Control slow = 1
  Settings.flag3.slow_servo_retain_results = 1; //TOMMY Control whether PWM MQTT results are retained. Default is to retain.
